...
[DynaTrade] [startup] plugin enabled version=0.8.0 language=en template=BALANCED templateOverrides=2 economy=ready restoredItems=32 restoredSignals=3
```
...
The current `0.8.0` line uses bounded main-thread apply draining for durable trades.
