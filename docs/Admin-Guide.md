...
[DynaTrade] [startup] plugin enabled version=0.7.3 language=en template=BALANCED templateOverrides=2 economy=ready restoredItems=32 restoredSignals=3
```
...
The current `0.7.3` production line uses bounded main-thread apply draining for durable trades.
