...
**Cause:**
This is usually the bounded apply stage doing its job. In `0.8.0`, durable trades can be applied through a controlled main-thread drain instead of all at once.
