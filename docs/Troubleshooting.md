...
**Cause:**
This is usually the bounded apply stage doing its job. In `0.7.1`, durable trades can be applied through a controlled main-thread drain instead of all at once.
